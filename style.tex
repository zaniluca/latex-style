...
\newenvironment{example}{\begin{blackBox}\begin{exampleT}}{\end{exampleT}\end{blackBox}}
...
% To get the commit hash, see https://gist.github.com/kbjarkefur/88820e5a5365b3f707b6b20aee57cf8a
\usepackage{xstring}
\usepackage{catchfile}

% Set user input - Always point to project root .git folder
\makeatletter
\newcommand{\gitfolder}{\@currdir/../.git} % Start from current directory and go up one level
\makeatother
...
\StrGobbleRight{\commit}{1}[\commithash]
